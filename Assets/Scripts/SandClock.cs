...
{
    [SerializeField]public Image fillTopImage;
    [SerializeField]public Image fillBottomImage;
    ...
    public void Begin()
    {
        ...
        ++currentRound;
        transform
           .DORotate(Vector3.forward * 360f, .8f, RotateMode.FastBeyond360)
           .From(Vector3.zero)
    ...
    public void ResetAll()
    {
        ...
        roundText.DOFade(0f, 0f);
        sandPyramidRect.DOScaleY(0f, 0f);
        sandPyramidRect.anchoredPosition = Vector2.up * defaultSandPyramidYPos;
        SetRoundText(totalRounds);
    }
